		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#stateofmichigan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stateofmichigan-display": {
								"semanticObject": "stateofmichigan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stateofmichigan",
									"url": sap.ui.require.toUrl("stateofmichigan")
								}
							}
						}
					}
